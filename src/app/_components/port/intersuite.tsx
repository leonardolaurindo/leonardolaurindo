      ...
      <div className="relative isolate">
        ...
        >
          ...
          <rect
            ...
            height="100%"
            strokeWidth="0"
            fill="url(#intersuite-pattern-bg)"
          ></rect>
        </svg>
        <div
              ...
              <div className="lg:ml-auto lg:text-right">
                <div className="relative z-10 inline-block pt-11 lg:pt-0">
                  <Carousel>
                    <CarouselContent>
                      <CarouselItem>
                        <ImageDialog
                          imgSrc="/portfolio/intersuite/header.webp"
                          alt="hero"
                        />
                      </CarouselItem>
                      <CarouselItem>
                        <ImageDialog
                          imgSrc="/portfolio/intersuite/canais_section.webp"
                          alt="hero"
                        />
                      </CarouselItem>
                      <CarouselItem>
                        <ImageDialog
                          imgSrc="/portfolio/intersuite/contact_section.webp"
                          alt="hero"
                        />
                      </CarouselItem>
                      <CarouselItem>
                        <ImageDialog
                          imgSrc="/portfolio/intersuite/other_page.webp"
                          alt="hero"
                        />
                      </CarouselItem>
                      <CarouselItem>
                        <ImageDialog
                          imgSrc="/portfolio/intersuite/reunion_page.webp"
                          alt="hero"
                        />
                      </CarouselItem>
                    </CarouselContent>
                ...
                <div className="pt-10 flex justify-center">
                  <div className="relative inline-flex  group">
                    <div className="absolute transitiona-all duration-1000 opacity-70 -inset-px bg-gradient-to-r from-purple-400 via-purple-800 to-purple-400 rounded-xl blur-lg group-hover:opacity-100 group-hover:-inset-1 group-hover:duration-200 animate-tilt"></div>
                    <a
                      href="https://api.whatsapp.com/send/?phone=5588981907153&text=Ol%C3%A1+Leo%2C+eu+vim+pelo+seu+site%21"
                      target="_blank"
          ...
          <div className=" lg:row-span-2 text-center md:text-start">
            <div className="hero-content">
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger>
                    <a
                      target="_blank"
                      href="https://intersuite.com.br"
                      className="text-sm flex m-4 p-1.5 rounded-lg bg-slate-50/35 hover:bg-slate-50/65 dark:text-black dark:bg-white/85 dark:hover:bg-white/55"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        x="0px"
              ...
              <p className="mb-8 max-w-[480px] text-base text-slate-600 dark:text-slate-400 text-justify">
                Desenvolvida com as melhores práticas de conversão, a Landing
                Page do InterSuite apresenta um design atraente e responsivo.
                Com sections estratégicas, como canais de comunicação,
                formulário de contato e depoimentos, a página oferece uma
                experiência envolvente aos visitantes. Projetada para garantir
                performance e velocidade excepcionais, a Landing Page do
                InterSuite é uma solução eficaz para apresentar o produto e
              ...
              <Accordion type="single" collapsible className="relative z-10">
                <AccordionItem value="item-1">
                  <AccordionTrigger>
                    Header Impactante e Navegação Intuitiva
                  </AccordionTrigger>
                  <AccordionContent>
                    O header da Landing Page do InterSuite é estrategicamente
                    projetado para cativar os visitantes desde o primeiro
                    instante. Com um efeito de digitação envolvente, ele destaca
                    as principais qualidades do sistema, criando uma impressão
                    duradoura. O menu flutuante complementa a experiência,
                    oferecendo uma navegação intuitiva e acessível em todas as
                    seções da página. Essa combinação permite que os visitantes
                    explorem facilmente os recursos e benefícios do InterSuite.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-2">
                  <AccordionTrigger>
                    Credibilidade Reforçada por Provas Sociais
                  </AccordionTrigger>
                  <AccordionContent>
                    Para estabelecer a credibilidade e demonstrar a eficácia do
                    InterSuite, a Landing Page inclui sections dedicadas a
                    provas sociais e depoimentos impactantes. A section de
                    provas apresenta métricas impressionantes, como o volume de
                    atendimentos realizados, a diversidade de nichos atendidos,
                    a quantidade de mensagens processadas e o número de empresas
                    que confiam na plataforma. Esses dados concretos transmitem
                    confiança aos visitantes. Além disso, a section de
                    depoimentos exibe relatos autênticos de clientes
                    satisfeitos, compartilhando suas experiências positivas com
                    o InterSuite por meio de um slider envolvente.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-3">
                  ...
                  <AccordionContent>
                    A Landing Page do InterSuite apresenta um formulário de
                    contato estrategicamente posicionado para facilitar a
                    interação entre os visitantes interessados e a equipe de
                    atendimento. Localizado em uma seção de destaque, o
                    formulário é projetado para ser intuitivo e de fácil
                    preenchimento. Com campos essenciais, como nome, email e
                    telefone, ele permite que os visitantes enviem suas
                    mensagens de forma rápida e conveniente. Ao enviar o
                    formulário, um atendente dedicado entra em contato
                    prontamente, fornecendo um atendimento personalizado e
                    eficiente. Essa abordagem proativa demonstra o compromisso
                    do InterSuite em oferecer uma experiência excepcional ao
        ...
        <div className="pt-5 pb-10">
          ...
          <div className="flex items-center justify-center space-x-4 gap-4">
            <svg
              ...
              height="55"
              viewBox="0 0 50 50"
              className="fill-zinc-500 transition hover:fill-zinc-600 dark:fill-zinc-400 dark:hover:fill-zinc-300"
            >
