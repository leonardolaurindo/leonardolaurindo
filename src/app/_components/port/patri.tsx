              ...
              <div className="relative z-10 inline-block pt-11 lg:pt-0">
                <Carousel>
                  <CarouselContent>
                    <CarouselItem>
                      <ImageDialog
                        imgSrc="/portfolio/patri/dashboard.jpg"
                        alt="hero"
                      />
                    </CarouselItem>
                    <CarouselItem>
                      <ImageDialog
                        imgSrc="/portfolio/patri/dark.jpg"
                        alt="hero"
                      />
                    </CarouselItem>
                    <CarouselItem>
                      <ImageDialog
                        imgSrc="/portfolio/patri/workers.jpg"
                        alt="hero"
                      />
                    </CarouselItem>
                    <CarouselItem>
                      <ImageDialog
                        imgSrc="/portfolio/patri/itens.jpg"
                        alt="hero"
                      />
                    </CarouselItem>
                    <CarouselItem>
                      <ImageDialog
                        imgSrc="/portfolio/patri/multi_companies.jpg"
                        alt="hero"
                      />
                    </CarouselItem>
                  </CarouselContent>
        ...
        <div className="lg:order-first lg:row-span-2 text-center md:text-start">
          <div className="hero-content">
            ...
            <p className="mb-8 max-w-[480px] text-base text-slate-600 dark:text-slate-400 sm:text-justify">
              Solução moderna de gestão de patrimônio que simplifica o controle
              de ativos empresariais. Com recursos avançados e interface
              intuitiva, a plataforma oferece praticidade e confiabilidade na
            ...
            <Accordion type="single" collapsible className="relative z-10">
              <AccordionItem value="item-1">
                <AccordionTrigger>
                  Cadastro e Identificação de Itens
                </AccordionTrigger>
                <AccordionContent>
                  A aplicação de controle de patrimônio permite o cadastro
                  detalhado de todos os itens que compõem o patrimônio da
                  empresa. Cada item, seja um equipamento de informática,
                  mobiliário ou qualquer outro ativo, pode ser registrado
                  individualmente com suas respectivas informações, como
                  descrição, data de aquisição, valor, entre outros. Além disso,
                  a aplicação gera automaticamente etiquetas QR Code únicas para
                  cada item cadastrado, facilitando sua identificação rápida e
                  precisa.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  Uma das funcionalidades destacadas da aplicação é o controle
                  eficiente da localização de cada item do patrimônio. É
                  possível atribuir a localização atual de um item, seja em uma
                  sala específica, com um colaborador responsável ou em qualquer
                  outro espaço da empresa. Além disso, todas as movimentações
                  dos itens são registradas, permitindo um histórico completo de
                  para onde foram movidos e por quem. Essa rastreabilidade é
                  essencial para manter o controle e a organização do
                  patrimônio.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-3">
                ...
                <AccordionContent>
                  ...
                  para registrar as manutenções realizadas nos itens. Quando um
                  item é retirado para manutenção, seja por motivos de reparo,
                  atualização ou qualquer outro serviço, é possível indicar essa
                  movimentação na aplicação. Da mesma forma, quando o item
                  retorna da manutenção, o registro é atualizado. Esse controle
                  de manutenções permite um acompanhamento preciso do histórico
                  de cada item, facilitando a gestão e a tomada de decisões
                  relacionadas à conservação e ao investimento no patrimônio da
                  empresa.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
