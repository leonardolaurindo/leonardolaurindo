            ...
            <div className="relative z-10">
                ...
                <div className="clients pt-16">
                    ...
                    <div className="flex items-center justify-center space-x-4 gap-4">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="65" height="65" viewBox="0 0 32 32" className="fill-zinc-500 transition hover:fill-zinc-600 dark:fill-zinc-400 dark:hover:fill-zinc-300">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 148 90" width="65" height="65" className="fill-zinc-500 transition hover:fill-zinc-600 dark:fill-zinc-400 dark:hover:fill-zinc-300">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="65" height="65" className="fill-zinc-500 transition hover:fill-zinc-600 dark:fill-zinc-400 dark:hover:fill-zinc-300">
